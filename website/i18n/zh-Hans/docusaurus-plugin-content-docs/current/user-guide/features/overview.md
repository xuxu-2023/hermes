...
- **[记忆提供商](memory-providers.md)** — 接入外部记忆后端（Honcho、OpenViking、Mem0、Hindsight、Holographic、RetainDB、ByteRover、Supermemory、Memori、Mnemosyne），实现跨会话用户建模和超越内置记忆系统的个性化。

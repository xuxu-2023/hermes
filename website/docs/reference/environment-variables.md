...
| `XIAOMI_BASE_URL` | Override Xiaomi MiMo Token Plan base URL (default: `https://token-plan-sgp.xiaomimimo.com/v1`). Use cluster selector in `hermes setup` for CN/AMS endpoints. |

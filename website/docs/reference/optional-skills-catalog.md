...
| [**devopsellence**](/docs/user-guide/skills/optional/devops/devops-devopsellence) | Deploy apps with the devopsellence CLI — initialize solo or shared workspaces, manage nodes and secrets, deploy, and inspect status. |

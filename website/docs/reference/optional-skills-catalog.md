...
| [**privy-wallet**](/docs/user-guide/skills/optional/blockchain/blockchain-privy) | Read-only Privy wallet and user inspection for Hermes — list embedded/external wallets and PII-minimized Privy user summaries. Does not sign messages or send transactions. |

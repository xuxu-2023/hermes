---
title: "Youtube Unified Api — Call YouTube APIs through MyBrandMetrics Discovery"
sidebar_label: "Youtube Unified Api"
...
Call YouTube APIs through MyBrandMetrics Discovery.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/media/youtube-unified-api` |
| Path | `optional-skills/media/youtube-unified-api` |
| Version | `1.0.0` |

...
Deploy apps with the devopsellence CLI — initialize solo or shared workspaces, manage nodes and secrets, deploy, and inspect status.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/devops/devopsellence` |
| Path | `optional-skills/devops/devopsellence` |
| Version | `1.0.0` |

---
title: "Media Delivery Prep"
sidebar_label: "Media Delivery Prep"
...
Use when a user wants to send, convert, compress, inspect, trim, or prepare media attachments for Hermes messaging platforms.
...
| Path | `skills/media/media-delivery-prep` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `media`, `attachments`, `ffmpeg`, `messaging`, `conversion`, `compression` |
| Related skills | [`songsee`](/docs/user-guide/skills/bundled/media/media-songsee), [`youtube-content`](/docs/user-guide/skills/bundled/media/media-youtube-content) |

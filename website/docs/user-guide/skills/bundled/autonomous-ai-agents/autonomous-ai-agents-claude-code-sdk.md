---
title: "Claude Code Sdk — Programmatic Claude Code via the official claude-agent-sdk Python package"
sidebar_label: "Claude Code Sdk"
description: "Programmatic Claude Code via the official claude-agent-sdk Python package"
---
...
Programmatic Claude Code via the official claude-agent-sdk Python package. Persistent multi-turn sessions via session resume, parallel orchestration across projects, and per-query cost tracking. Complements the existing claude-code skill for SDK-based use cases.
...
| Path | `skills/autonomous-ai-agents/claude-code-sdk` |
| Version | `1.0.0` |

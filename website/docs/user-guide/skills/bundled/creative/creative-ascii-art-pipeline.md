---
title: "Ascii Art Pipeline"
sidebar_label: "Ascii Art Pipeline"
description: "Use when building high-fidelity ASCII outputs from images or video, especially when you need named presets, glyph diagnostics, preview rendering, or Herm eik..."
---
...
Use when building high-fidelity ASCII outputs from images or video, especially when you need named presets, glyph diagnostics, preview rendering, or Herm eikon generation.
...
| Path | `skills/creative/ascii-art-pipeline` |
| Version | `1.0.0` |
| Author | Hermes Agent |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `ascii`, `eikon`, `chafa`, `braille`, `preview`, `diagnostics`, `terminal-art`, `video` |
| Related skills | [`ascii-art`](/docs/user-guide/skills/bundled/creative/creative-ascii-art), [`ascii-video`](/docs/user-guide/skills/bundled/creative/creative-ascii-video), `herm-tui-skin-development` |

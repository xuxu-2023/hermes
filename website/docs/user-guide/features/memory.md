...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, Hermes supports external memory provider plugins — including bundled providers and standalone options such as Memori and Scope Recall.

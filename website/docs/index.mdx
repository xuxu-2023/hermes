...
The self-improving AI agent built by [Nous Research](https://nousresearch.com). Hermes ships with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.

...
- **Runs anywhere, not just your laptop** — 7 terminal backends: local, Docker, SSH, Daytona, Singularity, Modal, and CubeSandbox. Daytona and Modal offer serverless persistence — your environment hibernates when idle, costing nearly nothing

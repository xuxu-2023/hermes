...
# Light/dark terminal detection + skin-color remap live in
# hermes_cli/light_mode.py (extracted from this file).  Re-exported here
# so existing `cli._hex_to_ansi(...)` / `cli._detect_light_mode()` call
# sites (and tests that monkeypatch them) keep working unchanged.
from hermes_cli.light_mode import (  # noqa: E402

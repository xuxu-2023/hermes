...
> Generated by: `python3 SKILL_DIR/scripts/evidence-store.py export`
...
- Evidence store: `.oss-forensics/evidence.json` (SHA-256 integrity: run `python3 SKILL_DIR/scripts/evidence-store.py verify`)

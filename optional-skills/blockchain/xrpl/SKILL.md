---
name: xrpl
description: Instruction-first XRP Ledger audit playbook for read-only account, trust-line, transaction, fee, reserve, and network checks using public XRPL JSON-RPC. No bundled executable, API key, private key handling, signing, or transaction submission.
version: 0.1.0

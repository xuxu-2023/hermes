...
def show_status(args):
    ...
    elif terminal_env == "apple_container":
        apple_image = os.getenv("TERMINAL_APPLE_CONTAINER_IMAGE", "nikolaik/python-nodejs:python3.11-nodejs20")
        print(f"  Apple Image:  {apple_image}")

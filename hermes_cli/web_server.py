...
def _fallback_profile_dicts(profiles_mod) -> List[Dict[str, Any]]:
    ...
    if default_home.is_dir():
        ...
        profiles.append({
            ...
            "role_specific_skill_count": _safe(lambda: profiles_mod._count_role_specific_skills(default_home), 0),
    ...
    if profiles_root.is_dir():
        for entry in sorted(profiles_root.iterdir()):
            ...
            profiles.append({
                ...
                "role_specific_skill_count": _safe(lambda entry=entry: profiles_mod._count_role_specific_skills(entry), 0),

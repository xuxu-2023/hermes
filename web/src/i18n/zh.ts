...
export const zh: Translations = {
  ...
  channels: {
    ...
    configuredSummary: "已配置 {configured}/{total} 个渠道。凭据会写入 {path}；网关会在下次重启时连接每个已启用渠道。",
    enablePlatform: "启用 {name}",
    errorToast: "错误：{error}",
    failedToRestart: "重启失败：{error}",
    failedToSave: "保存失败：{error}",
    gatewayNotRunning: "网关未运行。你可以先在这里配置渠道，然后通过 {command} 启动网关，或使用上方的重启按钮。",
  ...
  oauth: {
    ...
    description: "已连接 {connected}/{total} 个 OAuth 服务商。登录流程目前通过 CLI 运行；点击「复制命令」并粘贴到终端中进行设置。",
    connected: "已连接",
    expired: "已过期",
  ...
  achievements: {
    ...
    share: {
      ...
      tweet_text: "我刚在 Hermes Agent 解锁了 {tier_part}“{name}” ☤",
    },
  },

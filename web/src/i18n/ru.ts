...
export const ru: Translations = {
  common: {
    ...
    pluginLoadFailed:
      "Не удалось загрузить скрипт плагина. Проверьте вкладку «Сеть» (dashboard-plugins/…) и путь к плагинам на сервере.",
    pluginNotRegistered:
  ...
  status: {
    ...
    starting: "Запуск",
    startedInBackground: "Запущено в фоновом режиме — следите за журналами",
    stopped: "Остановлено",
  ...
  cron: {
    ...
    newJob: "Новая запланированная задача",
    ...
    noJobs: "Запланированные задачи не настроены. Создайте задачу выше.",
    last: "Последний",
    next: "Следующий",
    pause: "Пауза",
    resume: "Возобновить",
  ...
  pluginsPage: {
    ...
    installHeading: "Установка из GitHub или Git URL",
    installHint: "Используйте сокращение owner/repo или полный URL для клонирования через https:// либо git@. Для плагина в подпапке добавьте путь: owner/repo/path/to/plugin или <url>#path/to/plugin.",

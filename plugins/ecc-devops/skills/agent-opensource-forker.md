...
description: ECC Agent: opensource-forker -- specialized subagent for opensource forker tasks
---

# Agent: opensource-forker

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the opensource-forker specialization.

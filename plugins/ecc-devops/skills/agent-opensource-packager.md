...
description: ECC Agent: opensource-packager -- specialized subagent for opensource packager tasks
---

# Agent: opensource-packager

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the opensource-packager specialization.

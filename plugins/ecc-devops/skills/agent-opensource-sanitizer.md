...
description: ECC Agent: opensource-sanitizer -- specialized subagent for opensource sanitizer tasks
---

# Agent: opensource-sanitizer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the opensource-sanitizer specialization.

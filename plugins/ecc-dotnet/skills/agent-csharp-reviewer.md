...
description: ECC Agent: csharp-reviewer -- specialized subagent for csharp reviewer tasks
---

# Agent: csharp-reviewer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the csharp-reviewer specialization.

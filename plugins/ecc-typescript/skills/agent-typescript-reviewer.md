...
description: ECC Agent: typescript-reviewer -- specialized subagent for typescript reviewer tasks
---

# Agent: typescript-reviewer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the typescript-reviewer specialization.

---
name: gan-generator
description: ECC Agent: gan-generator -- specialized subagent for gan generator tasks
---

# Agent: gan-generator

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the gan-generator specialization.

---
name: gan-evaluator
description: ECC Agent: gan-evaluator -- specialized subagent for gan evaluator tasks
---

# Agent: gan-evaluator

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the gan-evaluator specialization.

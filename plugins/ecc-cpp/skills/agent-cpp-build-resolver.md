...
description: ECC Agent: cpp-build-resolver -- specialized subagent for cpp build resolver tasks
---

# Agent: cpp-build-resolver

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the cpp-build-resolver specialization.

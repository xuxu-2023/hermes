...
description: ECC Agent: rust-build-resolver -- specialized subagent for rust build resolver tasks
---

# Agent: rust-build-resolver

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the rust-build-resolver specialization.

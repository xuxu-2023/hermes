---
name: rust-reviewer
description: ECC Agent: rust-reviewer -- specialized subagent for rust reviewer tasks
---

# Agent: rust-reviewer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the rust-reviewer specialization.

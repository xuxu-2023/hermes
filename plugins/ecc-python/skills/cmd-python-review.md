---
name: cmd-python-review
description: ECC Command: /python-review -- slash command instructions from ECC
---

# Command: /python-review

This skill teaches the agent how to handle the `/python-review` slash command.

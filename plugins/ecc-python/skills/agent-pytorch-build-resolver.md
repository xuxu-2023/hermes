...
description: ECC Agent: pytorch-build-resolver -- specialized subagent for pytorch build resolver tasks
---

# Agent: pytorch-build-resolver

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the pytorch-build-resolver specialization.

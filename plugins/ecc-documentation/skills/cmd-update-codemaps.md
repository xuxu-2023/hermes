...
description: ECC Command: /update-codemaps -- slash command instructions from ECC
---

# Command: /update-codemaps

This skill teaches the agent how to handle the `/update-codemaps` slash command.

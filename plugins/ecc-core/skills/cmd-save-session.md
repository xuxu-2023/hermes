---
name: cmd-save-session
description: ECC Command: /save-session -- slash command instructions from ECC
---

# Command: /save-session

This skill teaches the agent how to handle the `/save-session` slash command.

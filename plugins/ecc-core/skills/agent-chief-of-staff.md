---
name: chief-of-staff
description: ECC Agent: chief-of-staff -- specialized subagent for chief of staff tasks
---

# Agent: chief-of-staff

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the chief-of-staff specialization.

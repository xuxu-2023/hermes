...
description: ECC Agent: performance-optimizer -- specialized subagent for performance optimizer tasks
---

# Agent: performance-optimizer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the performance-optimizer specialization.

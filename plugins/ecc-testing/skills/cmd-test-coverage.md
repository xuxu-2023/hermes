---
name: cmd-test-coverage
description: ECC Command: /test-coverage -- slash command instructions from ECC
---

# Command: /test-coverage

This skill teaches the agent how to handle the `/test-coverage` slash command.

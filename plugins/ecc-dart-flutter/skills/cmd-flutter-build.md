---
name: cmd-flutter-build
description: ECC Command: /flutter-build -- slash command instructions from ECC
---

# Command: /flutter-build

This skill teaches the agent how to handle the `/flutter-build` slash command.

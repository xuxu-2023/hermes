...
description: ECC Agent: flutter-reviewer -- specialized subagent for flutter reviewer tasks
---

# Agent: flutter-reviewer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the flutter-reviewer specialization.

...
description: ECC Agent: dart-build-resolver -- specialized subagent for dart build resolver tasks
---

# Agent: dart-build-resolver

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the dart-build-resolver specialization.

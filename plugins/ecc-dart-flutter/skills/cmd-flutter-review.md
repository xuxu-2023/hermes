---
name: cmd-flutter-review
description: ECC Command: /flutter-review -- slash command instructions from ECC
---

# Command: /flutter-review

This skill teaches the agent how to handle the `/flutter-review` slash command.

...
description: ECC Agent: kotlin-reviewer -- specialized subagent for kotlin reviewer tasks
---

# Agent: kotlin-reviewer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the kotlin-reviewer specialization.

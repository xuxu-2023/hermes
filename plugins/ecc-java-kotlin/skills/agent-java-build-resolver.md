...
description: ECC Agent: java-build-resolver -- specialized subagent for java build resolver tasks
---

# Agent: java-build-resolver

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the java-build-resolver specialization.

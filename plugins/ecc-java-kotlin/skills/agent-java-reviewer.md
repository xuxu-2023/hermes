---
name: java-reviewer
description: ECC Agent: java-reviewer -- specialized subagent for java reviewer tasks
---

# Agent: java-reviewer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the java-reviewer specialization.

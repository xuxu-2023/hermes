...
description: ECC Agent: kotlin-build-resolver -- specialized subagent for kotlin build resolver tasks
---

# Agent: kotlin-build-resolver

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the kotlin-build-resolver specialization.

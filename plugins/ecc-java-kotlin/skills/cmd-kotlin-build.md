---
name: cmd-kotlin-build
description: ECC Command: /kotlin-build -- slash command instructions from ECC
---

# Command: /kotlin-build

This skill teaches the agent how to handle the `/kotlin-build` slash command.

---
name: cmd-multi-frontend
description: ECC Command: /multi-frontend -- slash command instructions from ECC
---

# Command: /multi-frontend

This skill teaches the agent how to handle the `/multi-frontend` slash command.

---
name: cmd-multi-execute
description: ECC Command: /multi-execute -- slash command instructions from ECC
---

# Command: /multi-execute

This skill teaches the agent how to handle the `/multi-execute` slash command.

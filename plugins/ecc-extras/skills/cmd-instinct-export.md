...
description: ECC Command: /instinct-export -- slash command instructions from ECC
---

# Command: /instinct-export

This skill teaches the agent how to handle the `/instinct-export` slash command.

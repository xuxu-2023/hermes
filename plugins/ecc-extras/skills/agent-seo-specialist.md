---
name: seo-specialist
description: ECC Agent: seo-specialist -- specialized subagent for seo specialist tasks
---

# Agent: seo-specialist

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the seo-specialist specialization.

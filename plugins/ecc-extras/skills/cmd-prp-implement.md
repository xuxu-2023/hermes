---
name: cmd-prp-implement
description: ECC Command: /prp-implement -- slash command instructions from ECC
---

# Command: /prp-implement

This skill teaches the agent how to handle the `/prp-implement` slash command.

...
description: ECC Agent: healthcare-reviewer -- specialized subagent for healthcare reviewer tasks
---

# Agent: healthcare-reviewer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the healthcare-reviewer specialization.

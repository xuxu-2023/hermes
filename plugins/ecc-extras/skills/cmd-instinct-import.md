...
description: ECC Command: /instinct-import -- slash command instructions from ECC
---

# Command: /instinct-import

This skill teaches the agent how to handle the `/instinct-import` slash command.

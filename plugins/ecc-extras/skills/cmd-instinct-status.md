...
description: ECC Command: /instinct-status -- slash command instructions from ECC
---

# Command: /instinct-status

This skill teaches the agent how to handle the `/instinct-status` slash command.

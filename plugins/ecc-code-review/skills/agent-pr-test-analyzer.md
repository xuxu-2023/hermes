...
description: ECC Agent: pr-test-analyzer -- specialized subagent for pr test analyzer tasks
---

# Agent: pr-test-analyzer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the pr-test-analyzer specialization.

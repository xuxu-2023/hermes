...
description: ECC Agent: type-design-analyzer -- specialized subagent for type design analyzer tasks
---

# Agent: type-design-analyzer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the type-design-analyzer specialization.

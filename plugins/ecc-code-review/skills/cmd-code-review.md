---
name: cmd-code-review
description: ECC Command: /code-review -- slash command instructions from ECC
---

# Command: /code-review

This skill teaches the agent how to handle the `/code-review` slash command.

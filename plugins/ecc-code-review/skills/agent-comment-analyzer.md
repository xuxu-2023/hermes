...
description: ECC Agent: comment-analyzer -- specialized subagent for comment analyzer tasks
---

# Agent: comment-analyzer

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the comment-analyzer specialization.

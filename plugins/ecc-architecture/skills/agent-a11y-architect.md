---
name: a11y-architect
description: ECC Agent: a11y-architect -- specialized subagent for a11y architect tasks
---

# Agent: a11y-architect

This is an agent prompt template from ECC. Load this skill before spawning a
subagent via `delegate_task` to give it the a11y-architect specialization.

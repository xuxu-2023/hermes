...
_SKILL_REVIEW_PROMPT = (
    ...
    "  • If you update a skill, state the expected observable improvement.\n"
    "  • Prefer one focused change over broad rewrites.\n"
    "  • Do not claim success unless a tool result, test result, or user "
    "acceptance measured it.\n"
    "  • If there is no measurement yet, save the change as a hypothesis, "
    "pitfall, or next-loop expectation — not as proven.\n\n"

...
def build_assistant_message(agent, assistant_message, finish_reason: str) -> dict:
    ...
    # Codex Responses API: preserve encrypted compaction items generated by
    # responses.compact() so subsequent turns can replay the compacted prefix.
...
def handle_max_iterations(agent, messages: list, api_call_count: int) -> str:
    ...
    try:
        ...
        for msg in messages:
            ...
            for schema_foreign in ("tool_name", "codex_reasoning_items", "codex_compaction_items", "codex_message_items"):

...
KANBAN_GUIDANCE = (
    ...
    "any file operations. The workspace is yours for this run. When the task "
    "requires deliverable files, call `write_file` to create them under "
    "`$HERMES_KANBAN_WORKSPACE` — do not merely describe what you would write. "
    "Don't modify files outside it unless the task explicitly asks.\n"

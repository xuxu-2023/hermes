...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "If skill context may have changed since this session started, or if a fallback "
            "provider/model seems unsure about available skills, call skills_list/skill_view "
            "instead of relying only on the static <available_skills> index.\n"

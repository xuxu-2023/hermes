...
def finalize_turn(
    ...
    *,
    ...
    result = {
        ...
        "chat_model": getattr(agent, "_last_chat_model", None) or agent.model,
        "chat_provider": getattr(agent, "_last_chat_provider", None) or agent.provider,
        "chat_base_url": getattr(agent, "_last_chat_base_url", None) or agent.base_url,

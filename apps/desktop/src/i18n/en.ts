...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      remoteUrlDesc: 'User-facing public URL for the remote gateway. Path prefixes are supported, for example /hermes.',
      transportTitle: 'Transport',
      transportDesc: 'Choose whether Desktop connects to the gateway directly or through a local mTLS proxy.',
      transportDirect: 'Direct',
      transportLocalMtlsProxy: 'Local mTLS proxy',
      effectiveUrlTitle: 'Local proxy URL',
      effectiveUrlDesc: 'Advanced transport endpoint used by Desktop. The public gateway URL remains visible in settings.',
      ...
      connectedToViaProxy: (publicUrl, effectiveUrl, version) =>
        `Connected to ${publicUrl} via ${effectiveUrl}${version ? ` · Hermes ${version}` : ''}`,

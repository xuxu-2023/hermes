...
def test_normalize_lang_accepts_aliases():
    ...
    assert i18n._normalize_lang("Czech") == "cs"
    assert i18n._normalize_lang("čeština") == "cs"
    assert i18n._normalize_lang("cs-CZ") == "cs"
...
def test_t_explicit_lang():
    ...
    assert i18n.t("approval.denied", lang="cs").endswith("Zamítnuto")

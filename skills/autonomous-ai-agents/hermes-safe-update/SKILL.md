...
description: Use when the user says they are about to update Hermes, update macOS, reboot a Mac host, finish a Hermes update, or finish a macOS update on a Hermes gateway host.
version: 1.0.0
author: Hermes Agent
license: MIT

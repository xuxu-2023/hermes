...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "NOT DURABLE: background delegations belong to this parent process. If "
        "the parent session closes, /new resets it, /stop runs, or the process "
        "exits, unfinished subagents are discarded. Use cronjob or terminal "
        "background processes for work that must survive the current session.\n\n"

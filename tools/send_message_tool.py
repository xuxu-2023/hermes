...
# LINE recipient IDs: U (user DM), C (group), R (room). These are explicit
# push targets and should not fall through to channel-name resolution.
_LINE_TARGET_RE = re.compile(r"^\s*([UCR][A-Za-z0-9]{8,})\s*$")

...
In CLI/TUI sessions, the default deliver='origin' has no live channel; output is saved locally unless deliver targets a gateway destination such as 'telegram' or 'all'.
